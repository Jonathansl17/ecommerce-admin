...
export const REVIEWS_STRINGS = {
  ...
  empty: {
    all: 'Sin reseñas aún',
    allSubtitle: 'Las reseñas de clientes aparecerán aquí cuando comiencen a publicarlas.',
    pending: 'Sin reseñas pendientes',
    pendingSubtitle: 'No hay reseñas esperando moderación en este momento.',
    approved: 'Sin reseñas aprobadas',
    approvedSubtitle: 'Las reseñas que apruebes aparecerán aquí.',
    rejected: 'Sin reseñas rechazadas',
    rejectedSubtitle: 'Las reseñas que rechaces aparecerán aquí.',
  },
  errors: {
    fetchErrorTitle: 'No se pudieron cargar las reseñas',
    fetchError: 'Verifica tu conexión e intenta recargar la página.',
