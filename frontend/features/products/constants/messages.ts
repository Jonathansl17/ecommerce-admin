export const PRODUCTS_MESSAGES = {
  ...
  bulk: {
    ...
    subtitle: 'Selecciona los productos y define la nueva cantidad para cada uno.',
    colSelect: 'Ajustar',
    colName: 'Producto',
    colUnit: 'Unidad',
    colCurrentStock: 'Stock actual',
    colNewStock: 'Nueva cantidad',
    selectedCount: (n: number) => `${n} producto(s) listo(s) para ajustar`,
  ...
  history: {
    ...
    emptyMessage: 'No hay cambios de stock registrados para este producto.',
    colDate: 'Fecha',
