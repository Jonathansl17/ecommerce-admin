...
export function StockMovementHistory({ supply, refreshKey }: StockMovementHistoryProps) {
  const { movements, isLoading, error, pagination, refetch } = useStockMovements(supply.id);
