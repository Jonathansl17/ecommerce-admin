...
router.put('/supplies/:id', inventoryWriteRateLimit, requireAuth, requireRole(ADMIN_ROLES), validateUpdateSupply, update);
router.delete('/supplies/:id', inventoryWriteRateLimit, requireAuth, requireRole(ADMIN_ROLES), deleteSupply);
router.post('/supplies/:id/entries', inventoryWriteRateLimit, requireAuth, requireRole(ADMIN_ROLES), validateCreateEntry, createEntry);
